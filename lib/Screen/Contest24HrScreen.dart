...
import 'ContestGames/Balloon24hrContestGame.dart';
import 'ContestGames/DailyTapTap24hrContestScreen.dart';
import 'ContestGames/TissueBox24hrContestGame.dart';
import 'JigsawPuzzleContestGame.dart';
...
List<Player> parseData(DataSnapshot dbData) {
  ...
  if (dbData.value['gametype'] == 'tissue' ||
      dbData.value['gametype'] == 'balloon' ||
      dbData.value['gametype'] == 'tab') {
  ...
  if (playersList.length == 1) {
    if (dbData.value['gametype'] == 'tissue' ||
      ...
      players.add(Player.name2(
        ...
        timeStamp: playersList[0]['tissueCount'].toString(),
  ...
  ///////////////////////////////////////////////////IF OTHERS ALSO PLAYED THE GAME
    ...
    if (dbData.value['gametype'] == 'tissue' ||
      ...
      players.add(Player.name2(
        ...
        timeStamp: playersList[1]['tissueCount'].toString(),
    ...
    if (dbData.value['gametype'] == 'tissue' ||
      ...
      players.add(Player.name2(
        ...
        timeStamp: playersList[2]['tissueCount'].toString(),
...
class SecondContestScreen extends StatefulWidget {
  @override
...
class LeaderBoardScreenState extends State<SecondContestScreen> {
  @override
    ...
    return WillPopScope(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            allTranslations.text('24hr_contest'),
...
class LeaderUIInnerState extends State<LeaderUIInner> {
  ...
  Future checkPlayStatus() async {
    ...
    if (widget.data['gameType'] == 'tissue' ||
        widget.data['gameType'] == 'balloon' ||
        widget.data['gameType'] == 'tab')
      setState(() {
        showTimeStamp = false;
      });
    else
    ...
    print('MY VERSION: ${globals.currentAppVersion}');
    print('FB VERSION: ${globals.firebaseAppVersion}');

    if (globals.currentAppVersion >= globals.firebaseAppVersion) {
      if (gameStatus == 'new') {
