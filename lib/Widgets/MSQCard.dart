...
class MCQCardState extends State<MCQCard> {
  var color1;
  var color2;
  var color3;
  var color4;
  ...
  Future initializeVideo() {
    _videoCont = VideoPlayerController.network(
    ...
    // _initializeVideoPlayerFuture = _videoCont.initialize();
  }
  ...
  Future checkTrueAnswer(var color) async {
    await setTrueColor(color);
